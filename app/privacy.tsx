...
const PRIVACY = [
  {
    ...
    body: '• 필수: 이메일 주소, 이름, 닉네임\n• 선택: 프로필 사진, 선호 바이브\n• 자동수집: 기기 정보(OS 버전, 앱 버전), 위치정보(장소 검색 시 동의 후), 서비스 이용 기록',
  },
  {
  ...
  {
    title: '4. 개인정보 제3자 제공',
    body: '회사는 이용자의 동의 없이 개인정보를 제3자에게 제공하지 않습니다. 단, 법령에 의한 수사기관 요청, 서비스 제공을 위한 필수 협력사(클라우드 서버 등)에의 업무 위탁은 예외로 합니다.',
  },
  {
    title: '5. 개인정보 처리 위탁',
  ...
  {
    title: '7. 위치정보 처리',
    body: '위치정보는 장소 검색 및 주변 바이브 탐색 기능에 한해 사용됩니다. 이용자가 위치 권한을 거부한 경우에도 기본 서비스 이용이 가능하며, 위치 기반 기능만 제한됩니다.',
  },
  {
    title: '8. 개인정보 보호책임자',
